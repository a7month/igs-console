package com.igs.platform.console.formatter;
	...
	public void printMBean(Collection mbean) {
		for (Iterator i = mbean.iterator(); i.hasNext();) {
			...
			if (obj instanceof ObjectInstance) {
				...
				printException(new UnsupportedOperationException(
						"Unknown mbean type: " + obj.getClass().getName()));
			}
		}
	}
	...
	public void printMessage(Collection msg) {
		for (Iterator i = msg.iterator(); i.hasNext();) {
			...
			if (obj instanceof Map) {
				...
				printException(new UnsupportedOperationException(
						"Unknown message type: " + obj.getClass().getName()));
			}
		}
	}
